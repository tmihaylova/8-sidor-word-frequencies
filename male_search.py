...
if __name__ == "__main__":
    male_search_url = 'https://ws.spraakbanken.gu.se/ws/korp/v8/query?default_context=1 sentence&&start=0&end=15000&corpus=ATTASIDOR&cqp=[(word = "man" | word = "mannen" | word = "män" | word = "männen")]&incremental=true&default_within=sentence'
    data = fetch_json(male_search_url)
